...
public enum ErrorCode {
    ...
    ERR_BATCH_DROP_PARTITION_UNSUPPORTED_FOR_NONRANGEPARTITIONINFO(5508, new byte[] {'4', '2', '0', '0', '0'},
            "Batch drop partition only support RangePartitionInfo"),
    ERR_BATCH_DROP_PARTITION_UNSUPPORTED_FOR_MULTIPARTITIONCOLUMNS(5509, new byte[] {'4', '2', '0', '0', '0'},
